...
public class AddressBook {
    ...
    int choice;
    ArrayList<com.bridgelabz.uc6.Contacts> contactList = new ArrayList<>();
    public void addNewContact() {														 //Method to Add New Contact to AddressBook
        com.bridgelabz.uc6.Contacts contacts = new com.bridgelabz.uc6.Contacts();
    ...
    public void displayContact() {															    //Method to Show the Contact Details
        for(com.bridgelabz.uc6.Contacts contact : contactList) {
